...
class SmsListenerModule : public titanium::Proxy
{
public:
	explicit SmsListenerModule(jobject javaObject);
...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> hasSMSReceivePermission(const v8::Arguments&);
